...
<script type="text/javascript">
	...
	function sfUPD(staff_id,staff_name,staff_hp,staff_gender,staff_introduce,staff_birth
					,pi_base_pay,pi_join_day,rank_num,pi_private_pay,pi_group_pay,pi_num	
	){
		alert(staff_id);
...
<div id="stupdate">
	...
	<!-- ================================= [[ 화면전환 ]] =================================================== -->
		...
		<div class="homefr" style="padding-right:10px;">
           ...
           '<%=rMap.get("RANK_NUM") %>','<%=rMap.get("PI_PRIVATE_PAY") %>','<%=rMap.get("PI_GROUP_PAY") %>'
           ,'<%=rMap.get("PI_NUM") %>')" >정보수정</a>
       </div>
  ...
  <div class="modal-dialog">
   ...
   <fieldset id="trfieldset">
      <form id="add_coach_form2">
         ...
         <input type="hidden" name="pi_num" id="mpi_num">
         <p>
         ...
         <p data-tab="basic">
            ...
            <input type="radio" id="sex-M" value="남성" name="staff_gender"  >
            <label id="trlabel3">남성</label>
            <input type="radio" id="sex-M" value="여성" name="staff_gender" >
