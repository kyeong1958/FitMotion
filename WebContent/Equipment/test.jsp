...
<%@ include file="/shop/Goodsmodal.jsp"%>
    ...
    <div class="section" id="sec">
        <div class="Menufl">
         <ul id="tabul">
            ...
            <li>
               <button type="button" class=" tabBtn" value="nonPaymentMember"  rel="1" href="#">휴지
                  <span>6</span>
               </button>
            </li>
            <li>
               <button type="button" class=" active tabBtn" value="AVAILABLE"  rel="2" href="#">수건           
                  <span>6</span>
               </button>
            </li>
            <li>
               <button type="button" class=" tabBtn" value="EXPIRED"  rel="0" href="#">등
                  ...
                  <div class="modal-body" id="MI-body">
                     ...
                     <form id="gd_insert">
                        <p>
                           ...
                           <input type="text" name="go_name" placeholder="이름 입력" style="margin-right: 25px;">
                        </p>
                         <p>
                           <label style="margin-left: 12px; margin-right: 16%">종류</label>
                           <input type="text" name="go_type" class="calendar hasDatepicker">
                        </p> 
                     <p class="birth">
                           <span class="label" style="margin-right: 91px;">등록일</span>
                           <input  type="text" name="purchase_date" class="calendar hasDatepicker">
                        </p>
                     <p class="birth">
                           <span class="label" style="margin-right: 16%;">가격</span>
                           <input  type="text" name="purchase_price" class="calendar hasDatepicker">
                        </p>
                     <p class="birth">
                           <span class="label" style="margin-right: 16%;">재고</span>
                           <input  type="text" name="go_stock" class="calendar hasDatepicker">
                        </p>
                     </form>
                  </fieldset>
                  </div>
