    ...
    <div class="section" id="sec">
        <div class="Menufl">
         <ul id="tabul">
            ...
            <li>
               <button type="button" class=" tabBtn" value="nonPaymentMember"  rel="1" href="#">런닝머신
                  <span>6</span>
               </button>
            </li>
            <li>
               <button type="button" class=" active tabBtn" value="AVAILABLE"  rel="2" href="#">싸이클            
                  <span>6</span>
               </button>
            </li>
            <li>
               <button type="button" class=" tabBtn" value="EXPIRED"  rel="0" href="#">덤벨
...
<!--==================================[[검색 조회 부분 시작 ]]====================================================  -->
 ...
 <!-- ===========================================[[버튼 부분  여기서 부터 카드 부분 붙히기]]===============================================================  -->
   ...
   <div class="select_option" id="selectoption">
        ...
        <div class="B_fr">
            <input type="checkbox" id="fr_checkAll" name="checkAll" onClick="checkAll();"/>
