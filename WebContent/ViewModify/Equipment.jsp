	...
	<form>
		<div class="card-plus-wrap" style="height: 198px; padding-left: 35px;">
			...
			<div class="input-wrap">
				<ul>
					<li class="name"><input type="text" placeholder="기구명"
					...
					<br>
					<li class="manager"><span class="tit">작동여부</span>
					...
					<li class="repair">
						...
						<input type="text" style="width: 148px;" cusnum-item valid" required=""
					...
					<div class="btn-area">
						<button type="button" style="float: right; margin-right: 279px;
													margin-top: -151px; height: 112px;">등록
						</button>
					</div>
				</ul>
			</div>
				...
				<div class="cardWide-wrap">
					<div class="tit-area">
						<div class="ui checkbox fl" style="margin-top: 1px">
							<input type="checkbox"> <label for="checkbox-cust1"/>
								<span><span>
								</span></span>
							</label>
						</div>
