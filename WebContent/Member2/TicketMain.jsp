...
<%@ include file="/Member2/TicketMaincss.jsp"%>
...
<!-- ================================= [[ 화면전환 ]] =================================================== -->
	...
	$(function () {
		 $(".product-category ul li").click(function () {
			        $(".product-category ul li").removeClass("active").css("background-color", "#9fa0aa");
			         $(this).addClass("active").css ("background-color", "#2196F3");
			       
		 }); 
		});

		$(function () {
		 $("#MC-ul li button").click(function () {
			        $("#MC-ul li button").removeClass("active").css("color", "#333");
	...
	<div class="tab_area">
	   <div class="section">
	      <ul id="MC-ul">
	         ...
	         <li>
	            <button type="button" >프로모션 상품</button>
	         </li>
	      </ul>
	   </div>
	</div>  
...
<!-- /* -----------------------------메인 분류 카테고리 부분 -----------------------------*/-->
   ...
   <div class="section" style="margin-top: 0; padding-top: 15px;">
      ...
      <div class="column width_left_add" style="height: 680px; padding: 10px; width: calc((70% - 21px) / 3); padding-left: 0px; padding-right: 0px;">
          <!--=====================================분류 시작 =================================  -->
		         <div class="product-category">
		            <ul>
		               <li class="btn blue" >이용권 분류</li>
		               <li class="btn gray">카테고리 분류</li>
		            </ul>
		         </div>
          <!--=====================================분류 끝 =================================  -->
         <!--======================================분류의 메뉴 부분 시작 =============================  -->
		         <div style="margin-top: 10px; height: 95%; overflow: hidden; overflow-y: auto;">
			            ...
			            <ul data-template="tickets" style="list-style: none">
				            <li style="margin-top: 10px">
				               <span class="pr_btn btn text-border c_black">전체</span>
				            </li>	
				            <li style="margin-top: 10px">
				               <span class="pr_btn btn text-border c_green" >
				                  패키지 상품
				               <a  class="btn blue" style="float: right;">상품 추가</a>
				               </span>
				            </li>
			                  <li class="c_purple" style="margin-top: 10px">
			                     <span class="pr_btn btn text-border purple c_purple" >
			                        개인레슨
			                        <span style="float: right;">
			                           <a  class="btn blue" style="min-width: initial;">상세</a>
			                     <a class="btn blue">상품 추가</a>
			                        </span>
			                     </span>
			                  </li>
			                  <li class="c_purple" style="margin-top: 10px">
