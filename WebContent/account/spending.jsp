...
<body>
   ...
   <!-- ================================= [[ left ]] =================================================== -->
         <div class="row spending-box">
               ...
               <div class="col-sm-6" style="border-right:1px solid #BABBC2;padding-right:30px;">
                  ...
                  <div>
                     <div style="padding:0 0 5px">
                        ...
                        <span>
                           <select class="spend-combobox" id="select1">
                              <option value="1">지출선택</option>
                              <option value="2">기구매입 등록</option>
                              <option value="3">비품매입 등록</option>
                              <option value="4">일반지출 등록</option>
                              <option value="5">인건비지출 등록</option>
                              <option value="6">센터특별지출 등록</option>
                              <option value="7">일반지출 등록</option>
                              <option value="8">세금과공과</option>
                           </select>
                        </span>
                     </div>
                     <div style="padding:0 0 5px">
                        ...
                        <span>
                           <input type="text" class="spending-text" id="spend_name" style="width:260px;">
                        </span>
                     </div>
                     <div style="padding:0 0 5px">
                        <label class="spend-box-left-column">지출증빙 선택</label>
                        <span>
                           <select id="select2" class="spend-combobox">
                              <option value="1">지출증빙</option>
                              <option value="2">일반영수증</option>
                              <option value="3">현금형수증</option>
                              <option value="4">세금계산서</option>
                     ...
                     <div style="padding:0 0 5px">
                        ...
                        <span>
                           <input type="number" id="count" class="spending-text" style="width:260px;">
                        </span>
                     </div>
               ...
               <div class="col-sm-6" style="padding-left:30px;">
                  <div style="padding:0 0 5px">
                     ...
                     <select class="spend-combobox" id="selectpro2">
                             ...
                             <option value="2">킹규</option>
                             <option value="3">갓규</option>
                                <!--콤보박스 AJAX  -->
                              </select>
                     </span>
                  </div>
                  <div style="padding:0 0 5px">
                     ...
                     <span>
                        <!-- <span class="easyui-datebox" id="datebox" type="text"></span> -->
            ...
            <div class="spending-payment-bottom">
               <button type="button" onclick="test()" class="btn_cancle add">등록</button>
               <button type="button" class="btn_cancle cancle">취소</button>
            </div>
         </div>
      </div>
...
<script>
function test(){
	var exb_num = $("#select1").val();
	var ge_story = $("#spend_name").val();
	var ge_count = $("#count").val();
	var ge_biller = $("#selectpro2").val();
	var ge_date = $("#day").val();	
	var ge_totprice = $("#total_buy").val();
	...
	formdata.set("exb_num",exb_num);
	formdata.set("ge_story",ge_story);
	formdata.set("ge_count",ge_count);
	formdata.set("ge_biller",ge_biller);
	formdata.set("ge_date",ge_date);
	formdata.set("ge_totprice",ge_totprice);
	
	console.log(formdata.get("exb_num"));
	console.log(formdata.get("ge_story"));
	console.log(formdata);
	console.log(formdata);
	
	
	var xhr = new XMLHttpRequest();
	var url = "/account/expendINS.fm";
