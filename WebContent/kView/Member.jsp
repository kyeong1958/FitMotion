			...
			<div class="row" id="management">
					...
					<div class="col-sm-6 col-lg-6">
						 ...
						 <div class="row" style="margin-top:20%">
							<span>●&nbsp;등록일<input class="textbox" type="text" style="width:60%;margin-left:10%"></span>
						</div>
					<div class="row" style="margin-top:20%">
							<span>●&nbsp;성별&nbsp;&nbsp;&nbsp;
								<input type="radio" style="width:15%"><span>남</span>
								<input type="radio" style="width:15%"><span>여</span>
							</span>
					</div>
					</div>
					<div class="col-sm-6 col-lg-6">
						<div class="row">
							<span>●&nbsp;연락처<input class="textbox" type="text" style="width:70%;margin-left:7%"></span>
						</div>
						<div class="row" style="margin-top:20%">
							<span>●&nbsp;생년월일&nbsp;<input class="textbox" type="text" style="width:70%"></span>
						</div>
						<div class="row" style="margin-top:20%">
							<span>●&nbsp;등록사항<input class="textbox" type="text" style="width:60%;margin-left:10%"></span>
						</div>
					</div>
					</div> 
					<div class="col-sm-2 col-lg-2">
						...
						<div class="row">
							...
							<div class="row meminfo-second">
								<table class="meminfo-table">
									<tr>
										<td class="meminfo-table-header" style="width:20%">회원명</td>
										<td class="meminfo-table-header" style="width:20%">등록일</td>
										<td class="meminfo-table-header" style="width:60%">등록사항</td>
									</tr>
									<tr>
										<td class="meminfo-table-body">이름</td>
										<td class="meminfo-table-body">0000.00.00</td>
										<td class="meminfo-table-body">헬스 pt10회 이용권</td>
									</tr>
								</table>
								<table class="meminfo-table">
									<tr>
										<td class="meminfo-table-header" style="width:20%">성별</td>
										<td class="meminfo-table-header" style="width:20%">생년월일</td>
										<td class="meminfo-table-header" style="width:60%">주소</td>
									</tr>
									<tr>
										<td class="meminfo-table-body">남or여</td>
										<td class="meminfo-table-body">0000.00.00</td>
										<td class="meminfo-table-body">주소</td>
									</tr>
								</table>
							</div>
						</div>
