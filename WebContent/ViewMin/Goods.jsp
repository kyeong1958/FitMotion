...
<!-- 검색창 -->
	...
	<!-- 타이틀이름이랑검색어부분  끝-->
	<form id="GoodsForm">
		<div class="G-card-plus-wrap" style="height: 198px; padding-left: 35px;">
			<div class="G-tit-area" id="G-insert">
	   			<i>+</i>
	   			<span id="bi">비품</span>
			</div>
	...
	<!-- =================================화면단 중간     ================================ -->
	<!-- 화면 바끼는 부분  -->
		<div class="G-card-wide-wrap">
		   <ul id="custList">
		      <!-- 비품상세 -->
				<li class="G-card-wide-list" style="cursor: auto;">
					<div class="G-card-plus-wrap">
				   		<div class="G-tit-area" id="G-update">
							...
							<div class="G-num-area" style="cursor: pointer;">1</div>
							<div class="G-name-area" style="cursor: pointer;">
								<span>휴지</span>
							</div>
						</div>
						<div class="G-date-area" style="cursor: pointer;" onclick="goCustDetail(1);">
				   			<ul>
				      			<li id="G-li">
				      				<span class="tit">등록일</span>
						...
						<div class="G-info-area" style="cursor: pointer; margin-left: 100px;" onclick="goCustDetail(1);">
							<ul>
